...
class Review(BaseModel):
    ...
    summary:str=Field(description="A brief summary of the review either , negative, positive or neutral")
    sentiment:Literal["pros", "neg"]=Field(description="write down the sentiment of the review inside a list")
